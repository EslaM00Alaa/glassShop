...
//     let sql =""
//     let condition = `WHERE ${label}.type_id=${i}`;
//     if (+req.body.salary)
...
//     if (i < 6) {
//        sql = ` SELECT gp.product_id, gp.product_name, gp.salary AS salary_before,  (gp.salary - ((gp.salary * go.percent )/100))   AS salary_after, go.percent AS percent  , gp.model_number, typs.type_name AS "type", 
